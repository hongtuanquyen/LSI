...
EXT   TCOM_FLG   power_flag1;   // TCOM_FLG o file common.h
...
#define      CPW_ACCON_4MSCNT   16      /* 500ms/62.5ms    $Q: Xem file IO_sfr.c, thanh ghi BTCR(Basetimer controller) duoc set la 4ms. 4x16 = 64ms. */
