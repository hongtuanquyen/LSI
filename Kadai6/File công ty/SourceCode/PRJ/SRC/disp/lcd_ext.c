...
----------------------------------------------------------------
         2012/07/31      0.1      ha      新規作成
****************************************************************/
void Lcd_disp_base(BYTE mode_id)    // duoc dung trong Pw_power_key() trong file pw_func_ext.c, khi nhan key power(xem moudule KEY)
{
   BYTE mode;
...
void Lcd_accoff_send_req(void) // duoc goi dau tien trong file pw_main.c, trong h瀘 Pw_initial
                               // file excel giai thich: h瀘 n炸 dg de yeu cau cap nhat hien thi trong khi ACCOFF
{
