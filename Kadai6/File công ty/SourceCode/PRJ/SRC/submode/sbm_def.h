...
#define      fsbm_alm_onoff      sbm_flag.bit.bit4      /* almモードON/OFFﾌﾗｸﾞ   Alm mode ON / OFF flag */
...
EXT BYTE sbm_sct_mode;                  /* TESモード   TEST Mode*/
...
#define      CSBM_CLK_NORMAL      0         /* 時計調整済み     Clock da duoc dieu chinh xong  */
#define      CSBM_CLK_ADJUST      1         /* 時計時分の調整中 Dang trong qua trinh dieu chinh thoi gian*/
...
EXT   BYTE   sbm_alm_mode;               /* ALARM調整ﾓｰﾄﾞ   ALARM adjustment mode */
#define      CSBM_ALM_NORMAL      0         /* ALARM調整済み  gia tri Alarm da duoc dieu chinh xong */
#define      CSBM_ALM_ADJUST      1         /* ALARM時分の調整中  Dang trong qua trinh dieu chinh */
