...
/******************************************************************************
		...
		ˆø  ”	F–³‚µ
		–ß‚è’l	F–³‚µ
		‹@  ”\	FAlarm beep onŽžAPowerˆÈŠO‚Ì·°ONˆ—
----------------------------------------------------------------
C³—š—ð	y”NŒŽ“úzyVersionzy–¼‘Oz yà–¾z
----------------------------------------------------------------
			2012/7/25		0.1		lrj		V‹K
